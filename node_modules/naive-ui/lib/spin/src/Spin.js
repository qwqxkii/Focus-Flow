...
exports.spinProps = Object.assign(Object.assign({}, _mixins_1.useTheme.props), { contentClass: String, contentStyle: [Object, String], description: String, stroke: String, size: {
        type: [String, Number],
        default: 'medium'
    }, show: {
        type: Boolean,
...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const themeClassHandle = inlineThemeDisabled
            ...
            : undefined;
        const compitableShow = (0, vooks_1.useCompitable)(props, ['spinning', 'show']);
        const activeRef = (0, vue_1.ref)(false);
        (0, vue_1.watchEffect)((onCleanup) => {
            let timerId;
