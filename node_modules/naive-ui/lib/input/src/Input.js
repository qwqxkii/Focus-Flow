...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        function doUpdateValue(value, meta) {
            ...
            if (onInput)
                (0, _utils_1.call)(onInput, value, meta);
        ...
        function doChange(value, meta) {
            ...
            if (onChange)
                (0, _utils_1.call)(onChange, value, meta);
            uncontrolledValueRef.value = value;
            nTriggerFormChange();
        }
        function doBlur(e) {
        ...
        function handleWrapperKeyup(e) {
            if (props.onKeyup)
                (0, _utils_1.call)(props.onKeyup, e);
        }
        function handleWrapperKeydown(e) {
            if (props.onKeydown)
                (0, _utils_1.call)(props.onKeydown, e);
            switch (e.key) {
                case 'Escape':
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", { ref: "wrapperElRef", class: [
            ...
            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-input-wrapper` },
                ...
                type === 'textarea' ? ((0, vue_1.h)(_internal_1.NScrollbar, { ref: "textareaScrollbarInstRef", class: `${mergedClsPrefix}-input__textarea`, container: this.getTextareaScrollContainer, triggerDisplayManually: true, useUnifiedContainer: true, internalHoistYRail: true }, {
                    default: () => {
                        var _a, _b;
                    ...
                    (0, vue_1.h)("input", Object.assign({ type: type === 'password'
