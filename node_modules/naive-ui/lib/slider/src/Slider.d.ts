...
export declare const sliderProps: {
    ...
    readonly marks: PropType<Record<string, string | (() => VNodeChild)>>;
    readonly disabled: {
...
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    uncontrolledValue: import("vue").Ref<number | number[], number | number[]>;
    ...
    dotTransitionDisabled: import("vue").Ref<boolean, boolean>;
    ...
    handleRailRef: import("vue").Ref<HTMLElement | null, HTMLElement | null>;
    ...
    followerEnabledIndexSet: import("vue").Ref<Set<number> & Omit<Set<number>, keyof Set<any>>, Set<number> | (Set<number> & Omit<Set<number>, keyof Set<any>>)>;
    ...
    indicatorThemeClass: import("vue").Ref<string, string> | undefined;
